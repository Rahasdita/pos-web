...
public class MasterKotaCtrl {
    @Autowired
    KotaDao kotaDao;
    private Logger logger=LoggerFactory.getLogger(MasterKotaCtrl.class);
    ...
    @ResponseBody
    public Kota findOne(@PathVariable Integer id, 
            HttpServletResponse response){
